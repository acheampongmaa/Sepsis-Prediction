...
# model_path = pathlib.Path('C:', 'Users', 'Guests', 'Desktop', 'Queen', 'DataAnalytics', 'Predicting Sepsis', 
#                           'Sepsis-Prediction', 'src', 'assets', 'ml_components', 'model-1.pkl')
# transformer_path =  pathlib.Path('C:', 'Users', 'Guests', 'Desktop', 'Queen', 'DataAnalytics', 'Predicting Sepsis', 
#                           'Sepsis-Prediction', 'src', 'assets', 'ml_components', 'preprocessor.pkl')
# properties_path =  pathlib.Path('C:', 'Users', 'Guests', 'Desktop', 'Queen', 'DataAnalytics', 'Predicting Sepsis', 
#                           'Sepsis-Prediction', 'src','assets', 'ml_components', 'other-components.pkl')

model_path = r'C:/Users/Guests👨‍👧‍👧/Desktop/Queen/DataAnalytics/Predicting Sepsis/Sepsis-Prediction/src/assets/ml_components/model-1.pkl'
transformer_path= r'C:/Users/Guests👨‍👧‍👧/Desktop/Queen/DataAnalytics/Predicting Sepsis/Sepsis-Prediction/src/assets/ml_components/preprocessor.pkl'
properties_path = r'C:/Users/Guests👨‍👧‍👧/Desktop/Queen/DataAnalytics/Predicting Sepsis/Sepsis-Prediction/src/assets/ml_components/other-components.pkl'
